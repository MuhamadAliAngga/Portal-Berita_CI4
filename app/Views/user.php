                            ...
                            foreach ($data as $user) : ?>
                                <tr>
                                    ...
                                    <td class="text-center">
                                        <button type="button" data-toggle="modal" data-target="#detail<?= $user['id_user'] ?>" class="btn mb-1 btn-info btn-sm"><i class="fa fa-eye"></i></button>
...
<?php foreach ($data as $row) : ?>
    <div class="modal fade" id="detail<?= $row['id_user'] ?>" tabindex="-1" role="dialog" aria-labelledby="detailTitle<?= $row['id_user'] ?>" aria-hidden="true">
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="detailUsername<?= $row['id_user'] ?>" value="<?= $row['username'] ?>" readonly>
                    </div>
                    <div class="form-group">
                        <label for="detailAkses<?= $row['id_user'] ?>">Akses:</label>
                        <input type="text" class="form-control" id="detailAkses<?= $row['id_user'] ?>" value="<?= $row['akses'] == 1 ? 'Admin' : 'Penulis' ?>" readonly>
                    </div>
                </div>
                <div class="modal-footer">
                    <button type="button" class="btn btn-secondary" data-dismiss="modal">Close</button>
